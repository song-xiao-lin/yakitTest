...
const App: React.FC = memo(() => {
    ...
    useEffect(() => {
        ...
        // 通知应用退出
        ipcRenderer.on("close-yakitEngineLinkWin-renderer", async (e, res: any) => {
            ipcRenderer.invoke("app-exit", {showCloseMessageBox: true, isIRify: isIRify(), isYakitEngineLinkWin: true})
        })
        return () => {
            ipcRenderer.removeAllListeners("close-yakitEngineLinkWin-renderer")
        }
    }, [])
